...
export class LedControl {
    ...
    public getAvailableLedGroups(): Array<string> {
        return Array.from(Object.keys(LedControl._ledGroups));
    }
    ...
    public turnLedsOff(): void {
        let ledGroup: number = LedControl._ledGroups.all_lights;
    ...
    public setLedRgb(ledGroup: string, R: number, G: number, B: number): void {
        this._sendAllLEDsWith32BitMaskCommand(LedControl._ledGroups[ledGroup], [R, G, B]);
    }

    public setLedColor(ledGroup: string, color: string): void {
        this._sendAllLEDsWith32BitMaskCommand(LedControl._ledGroups[ledGroup], LedControl._colors[color]);
    ...
    public setAllLedsRgb(R: number, G: number, B: number): void {
        ...
        this._sendAllLEDsWith32BitMaskCommand(LedControl._ledGroups.all_lights, ledBrightnessValues);
    }
    ...
    public setMultipleLedsRgb(ledGroups: Array<string>, R: number, G: number, B: number): void {
    ...
    private static readonly _ledBitmasks: LedBitmasks = {
    ...
    private static readonly _ledGroups: LedGroups = {
        status_indication_left: LedControl._ledBitmasks.left_status_indication_red |
            LedControl._ledBitmasks.left_status_indication_green |
            LedControl._ledBitmasks.left_status_indication_blue,
        status_indication_right: LedControl._ledBitmasks.right_status_indication_red |
            LedControl._ledBitmasks.right_status_indication_green |
            LedControl._ledBitmasks.right_status_indication_blue,
        headlight_left: LedControl._ledBitmasks.left_headlight_red |
            LedControl._ledBitmasks.left_headlight_green |
            LedControl._ledBitmasks.left_headlight_blue,
        headlight_right: LedControl._ledBitmasks.right_headlight_red |
            LedControl._ledBitmasks.right_headlight_green |
            LedControl._ledBitmasks.right_headlight_blue,
        battery_door_front: LedControl._ledBitmasks.battery_door_front_red |
            LedControl._ledBitmasks.battery_door_front_green |
            LedControl._ledBitmasks.battery_door_front_blue,
        battery_door_rear: LedControl._ledBitmasks.battery_door_rear_red |
            LedControl._ledBitmasks.battery_door_rear_green |
            LedControl._ledBitmasks.battery_door_rear_blue,
        power_button_front: LedControl._ledBitmasks.power_button_front_red |
            LedControl._ledBitmasks.power_button_front_green |
            LedControl._ledBitmasks.power_button_front_blue,
        power_button_rear: LedControl._ledBitmasks.power_button_rear_red |
            LedControl._ledBitmasks.power_button_rear_green |
            LedControl._ledBitmasks.power_button_rear_blue,
        brakelight_left: LedControl._ledBitmasks.left_brakelight_red |
            LedControl._ledBitmasks.left_brakelight_green |
            LedControl._ledBitmasks.left_brakelight_blue,
        brakelight_right: LedControl._ledBitmasks.right_brakelight_red |
            LedControl._ledBitmasks.right_brakelight_green |
            LedControl._ledBitmasks.right_brakelight_blue,
        all_lights: LedControl._ledGroups.status_indication_left |
            LedControl._ledGroups.status_indication_right |
            LedControl._ledGroups.headlight_left |
            LedControl._ledGroups.headlight_right |
            LedControl._ledGroups.battery_door_front |
            LedControl._ledGroups.battery_door_rear |
            LedControl._ledGroups.power_button_front |
            LedControl._ledGroups.power_button_rear |
            LedControl._ledGroups.brakelight_left |
            LedControl._ledGroups.brakelight_right,
        undercarriage_white: LedControl._ledBitmasks.undercarriage_white
    };
}


interface LedBitmasks {
    [key: string]: number;
}
