...
export function parseGetGyroDegreesPerSecondResponse(dataRawBytes: Array<number>): IGetGyroDegreesPerSecondResponse {
	...
	let getGyroDegreesPerSecondResponse: IGetGyroDegreesPerSecondResponse = {
		pitch: pitch,
		roll: roll,
		yaw: yaw
	};
	
	return getGyroDegreesPerSecondResponse;
}

export interface IGetGyroDegreesPerSecondResponse {
