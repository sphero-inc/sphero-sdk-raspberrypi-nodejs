...
export function parseSendRobotToRobotInfraredMessageRequest(requestBody: any): Array<number> {
	...
	dataRawBytes.concat(frontLeftStrengthBytes);
	...
	dataRawBytes.concat(frontRightStrengthBytes);
	...
	dataRawBytes.concat(backRightStrengthBytes);
	...
	dataRawBytes.concat(backLeftStrengthBytes);
