...
export function parseGetMotorThermalProtectionStatusResponse(dataRawBytes: Array<number>): IGetMotorThermalProtectionStatusResponse {
    ...
    let getMotorThermalProtectionStatusResponse: IGetMotorThermalProtectionStatusResponse = {
    ...
    return getMotorThermalProtectionStatusResponse;
}

export interface IGetMotorThermalProtectionStatusResponse {
