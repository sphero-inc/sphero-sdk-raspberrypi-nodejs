...
export function parseRawMotorsRequest(requestBody: any): Array<number> {
    ...
    dataRawBytes = dataRawBytes.concat(leftModeBytes);
    ...
    dataRawBytes = dataRawBytes.concat(leftSpeedBytes);
    ...
    dataRawBytes = dataRawBytes.concat(rightModeBytes);
    ...
    dataRawBytes = dataRawBytes.concat(rightSpeedBytes);
