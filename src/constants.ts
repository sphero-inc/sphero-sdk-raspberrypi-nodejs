...
export class ApiFlags {
    ...
    public static readonly defaultResponseFlags: number = ((ApiFlags.isResponse) | (ApiFlags.resetInactivityTimeout) | (ApiFlags.packetHasTargetId) | (ApiFlags.packetHasSourceId));
}
